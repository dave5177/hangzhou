...
public class CanvasControl extends Canvas implements Runnable,
	...
	public final static String VERSION = "Version_JS_1.1.1";
	...
	private void loadJs_tool(MIDlet midlet) {
		js_tool = new JS_IPTV_PORP_TOOL(midlet, this, GAME_PROP_CODE,
				"productIDa5000000000000000218949");
	...
	private void getServerInfo(MIDlet midlet) {
		...
		imageServerUrl = midlet.getAppProperty("ImageServerUrl_JS");
		if (imageServerUrl == null) {
			// imageServerUrl = "http://222.46.20.151:8055/jpsc";// 本地地址
			imageServerUrl = "http://61.160.131.57:8083/GameResource/jpsc";// 江苏
		}
	}
