		...
		if (index_choose == 0) {
			if (CanvasControl.rank_win != null) {
				...
				for (int i = 0; i < size; i++) {
					...
					g.drawString(stra_t[0], 30, 154 + i * 30, Graphics.HCENTER
							| Graphics.TOP);
					g.drawString(C.deUserName_base64(stra_t[1]), 210, 154 + i * 30, Graphics.HCENTER
							| Graphics.TOP);
					g.drawString(stra_t[2], 390, 154 + i * 30, Graphics.HCENTER
							| Graphics.TOP);
					g.drawString(stra_t[3], 580, 154 + i * 30, Graphics.HCENTER
							| Graphics.TOP);
				}
			}
			...
			if (CanvasControl.rank_level != null) {
				...
				for (int i = 0; i < size; i++) {
					...
					g.drawString(stra_t[0], 30, 154 + i * 30, Graphics.HCENTER
							| Graphics.TOP);
					g.drawString(C.deUserName_base64(stra_t[1]), 300, 154 + i * 30, Graphics.HCENTER
							| Graphics.TOP);
					g.drawString(stra_t[2], 580, 154 + i * 30, Graphics.HCENTER
							| Graphics.TOP);
				}
			}
