...
public class Player {
	 ...
	 * @return
	 */
	public boolean isTopLevel(int carIndex) {
		if (carRealParams[carIndex][0] < CanvasControl.carMaxPower[cars[carIndex][0]][0])
			return false;
		if (carRealParams[carIndex][1] < CanvasControl.carMaxPower[cars[carIndex][0]][1])
			return false;
		return true;
	}
