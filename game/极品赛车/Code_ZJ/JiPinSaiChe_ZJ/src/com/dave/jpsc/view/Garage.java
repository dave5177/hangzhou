...
public class Garage implements Showable {
	...
	public void keyPressed(int keyCode) {
		...
		case C.KEY_FIRE:
			...
			case 1://升级
				boolean isTop = false;
				if(CanvasControl.month < 2)
					isTop = (canvasControl.me.cars[index_car_choose][4] > 20 || canvasControl.me.isTopLevel(index_car_choose));
				else 
					isTop = canvasControl.me.isTopLevel(index_car_choose);
				...
				if(isTop) {//顶级
					...
					canvasControl.buyGoods(16, false);
				}
				break;
			case 2://出战
