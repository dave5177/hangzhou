...
//	public static final String COMPANYURL_PHP = "http://192.168.1.197/";//本公司内部的服务器
	public static final String COMPANYURL_PHP = "http://61.191.44.224:8080/www.iptvgame.com/";// 安徽的服务器
...
//		heightRow = h_font;
	 ...
	 * @return 得到的字符数组
	 */
	public static String[] subString(String str, char c, int length) {
...
//C.out("截取字符串始末位置--------起始：" + index + "----结束：" + end);
	...
	public static boolean rectInsect(Rect rect1, Rect rect2) {
		return rectInsect(rect1.x, rect1.y, rect1.w, rect1.h, rect2.x, rect2.y, rect2.w, rect2.h);
	}
