...
public class Dialog implements Showable {
	...
	private void showGoodsPrice(Graphics g) {
		String price = canvasControl.js_tool
				.getSpecificPropsPrice(CanvasControl.A_GOODS_PARAM[CanvasControl.goodsIndex][0]);
		C.drawString(g, img_number, price, "0123456789.", 235, 208, 10, 15, 0,
				0, 0);
		g.drawImage(img_unit_price, 235 + price.length() * 10, 206, 0);
	}
				...
				case 5:// 购买道具
					...
					try {
						canvasControl.js_tool
								.do_BuyProp(
										Image.createImage("/js/goods_name_"
												+ CanvasControl.goodsIndex
												+ ".png"),
