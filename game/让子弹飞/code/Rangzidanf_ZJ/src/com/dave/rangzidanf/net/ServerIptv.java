...
//				C.out("count:"+CanvasControl.v_RankAll.size());
	...
	public void doGetUserProfile(){
		...
		encryptedStr = getUrl(".get", submitURL);
...
C.out("-----------------------------------\n");
	...
	public void doGetRank(){
		...
		submitURL = "iptv=" + CanvasControl.iptvID + 
		"&limit=10";
		encryptedStr = getUrl(".rank", submitURL);
...
C.out("-----------------------------------\n");
	...
	public void doSendUserInfo(){
		...
		encryptedStr = getUrl(".info.edit", submitURL);
...
C.out("-----------------------------------\n");
	...
	public void doSendScore(){
		...
		encryptedStr = getUrl(".totalscore.edit", submitURL);
