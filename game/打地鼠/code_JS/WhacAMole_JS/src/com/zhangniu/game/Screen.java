...
public class Screen extends Canvas implements Runnable, JS_IPTV_Listenner{

	public static String url = "http://122.224.212.68/props/propsAuth.py";
	// public static String url="http://122.224.212.67/props/propsAuth.py";
	...
	// 泰山服务器
	public static final String COMPANYURL = "http://61.160.131.57:8083/www.iptvgame.com/";//江苏服务器
	// public static final String COMPANYURL =
	...
	public static JS_IPTV_PORP_TOOL js_tool;//江苏移植工具
	
	public static final String VERSION = "Version JS_2.0.1";//版本信息
	...
	public Screen(MainMIDlet m) {
		...
		new Props(iptvID).getCoin();
		new Props(iptvID).getPropID();
...
//			setGameStatus(Screen.S_ALERT);
	...
	private void loadJs_tool(MIDlet midlet) {
		js_tool = new JS_IPTV_PORP_TOOL(midlet, this, Props.kindid, "productIDa5000000000000000217432");
