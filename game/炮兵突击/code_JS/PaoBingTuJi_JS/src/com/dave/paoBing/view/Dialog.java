...
public class Dialog implements Showable {
	...
	private void showGoodsPrice(Graphics g) {
		...
		switch (type) {
		case 5:// 生命价格
			// C.drawString(g, img_number, goodsPrice[0], "0123456789.", 225,
			// 258, 13, 18, 0, 0, 0);
			C.drawString(
					g,
					img_number,
			...
			break;
		case 6:// 子弹价格
			// C.drawString(g, img_number, goodsPrice[1], "0123456789.", 380,
			// 243, 13, 18, 0, 0, 0);
			C.drawString(
					g,
					img_number,
			...
			break;
		case 7:// 双倍威力价格
			// C.drawString(g, img_number, goodsPrice[2], "0123456789.", 230,
			// 243, 13, 18, 0, 0, 0);
			C.drawString(
					g,
					img_number,
