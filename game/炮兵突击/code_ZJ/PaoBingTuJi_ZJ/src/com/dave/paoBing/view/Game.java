...
public class Game implements Showable {
	 ...
	 * 往左拉动屏幕
	 */
	public boolean moveMapRight;

	/**
	 * 往右拉屏
	 */
	public boolean moveMapLeft;
	...
	public void initMession() {
		...
		case 1:
			int[][] temp_point = { { 54, 357 }, { 373, 231 }, { 858, 325 },
					{ 950, 474 } };
			a_point_pier = temp_point;
			for (int i = 0; i < a_point_pier.length; i++) {
				v_pier.addElement(new Pier(this, a_point_pier[i][0],
						a_point_pier[i][1]));
			}

			count_pier = v_pier.size();

			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(2),
					null, 0, 1, Enemy.CENTER_PIER));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(3),
					null, 1, 1, Enemy.CENTER_PIER));
			...
			break;
		case 2:
			int[][] temp_point2 = { { 55, 330 }, { 348, 330 }, { 430, 330 },
					{ 865, 310 } };
			...
			break;
		case 3:
			int[][] temp_point3 = { { 68, 376 }, { 731, 223 }, { 731, 355 },
					{ 815, 355 } // 有敌人2
			};
			...
			break;
		case 4:
			int[][] temp_point4 = { { 52, 358 }, { 418, 283 }, { 851, 201 },// 有敌人2
					{ 795, 472 },// 有敌人1
					{ 41, 116 }, { 123, 116 } };
			...
			break;
		case 5:
			int[][] temp_point5 = { { 46, 446 }, { 41, 154 }, { 713, 162 },// 有敌人1
					{ 788, 446 },// 有敌人1
					{ 881, 480 }, { 939, 480 } };
			...
			obstacle = new Obstacle(this, 5, 883, 332, Obstacle.WOOD_DOWN, 0,
					null);
			v_obstacle.addElement(obstacle);
			obstacle = new Obstacle(this, 5, 883, 451, Obstacle.WOOD_DOWN, 0,
					null);
			v_obstacle.addElement(obstacle);
			...
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(3),
					null, 1, 1, 0));
			v_enemy.addElement(new Enemy(this, null, (Obstacle) v_obstacle
					.elementAt(0), -2, 1, 0));
			count_enemy = v_enemy.size();
			break;
		case 6:
			int[][] temp_point6 = { { 55, 357 }, { 160, 379 }, { 755, 328 },// 有敌人1
					{ 899, 189 },// 有敌人1
					{ 847, 489 } // 有敌人1
			};
			...
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(2),
					null, -1, 1, 0));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(3),
					null, -2, 1, Enemy.LEFT_PIER));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(4),
					null, 1, 1, 0));
			count_enemy = v_enemy.size();
			break;
		case 7:
			int[][] temp_point7 = { { 43, 344 }, { 678, 150 }, { 764, 150 },
					{ 854, 150 }, { 944, 150 }, { 723, 353 }, { 923, 353 },
					{ 676, 318 } };
			...
			break;
		case 8:
			int[][] temp_point8 = { { 52, 407 }, { 298, 398 }, { 823, 413 },
					{ 760, 224 }, { 850, 224 }, { 940, 224 } };
			...
			break;
		case 9:
			int[][] temp_point9 = { { 56, 409 }, { 297, 369 }, { 322, 369 },
					{ 851, 127 }, { 853, 276 }, { 856, 409 } };
			...
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(3),
					null, -2, 1, Enemy.LEFT_PIER));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(4),
					null, -1, 2, Enemy.LEFT_PIER));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(5),
					null, 1, 1, 0));
			count_enemy = v_enemy.size();
			break;
		case 10:
			int[][] temp_point10 = { { 47, 384 }, { 735, 110 }, { 698, 342 },
					{ 914, 335 }, { 914, 391 }, { 914, 447 }, { 703, 509 },
					{ 786, 509 }, { 850, 509 } };
			...
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(1),
					null, -2, 2, Enemy.LEFT_PIER));
			v_enemy.addElement(new Enemy(this, null, (Obstacle) v_obstacle
					.elementAt(0), -1, 1, Enemy.LEFT_PIER));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(7),
					null, 1, 1, 0));
			count_enemy = v_enemy.size();
			break;
		case 11:
			int[][] temp_point11 = { { 55, 356 }, { 146, 407 }, { 644, 327 },
					{ 845, 82 }, { 811, 189 }, { 910, 344 }, { 796, 474 } };
			...
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(5),
					null, 0, 1, 0));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(6),
					null, 1, 1, 0));
			count_enemy = v_enemy.size();
			break;
		case 12:

			int[][] temp_point12 = { { 53, 358 }, { 345, 292 }, { 506, 292 },
					{ 885, 199 }, { 644, 472 }, { 724, 472 }, { 804, 472 } };
			...
			break;
		case 13:
			int[][] temp_point13 = { { 53, 441 }, { 753, 453 }, { 821, 453 },
					{ 907, 453 } };
			...
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(2),
					null, 1, 3, Enemy.LEFT_PIER));
			count_enemy = v_enemy.size();
			break;
		case 14:
			int[][] temp_point14 = { { 53, 357 }, { 221, 405 }, { 720, 211 },
					{ 758, 211 }, { 720, 68 }, { 800, 68 }, { 880, 68 },
					{ 720, 365 }, { 758, 365 }, { 720, 484 }, { 800, 484 },
					{ 880, 484 } };
			...
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(3),
					null, -1, 1, 0));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(10),
					null, 1, 2, Enemy.LEFT_PIER));
			count_enemy = v_enemy.size();
			break;
		case 15:
			int[][] temp_point15 = { { 43, 459 }, { 685, 411 }, { 781, 401 },
					{ 861, 401 }, { 608, 286 }, { 781, 286 }, { 867, 286 },
					{ 947, 286 }, { 776, 243 }, { 608, 243 }, { 508, 243 },
					{ 771, 196 }, { 612, 196 }, { 688, 157 }, { 33, 189 },
					{ 89, 189 } };
			...
			break;
		case 16:
			int[][] temp_point16 = { { 49, 340 }, { 533, 474 }, { 620, 304 },
					{ 671, 304 }, { 876, 191 }, { 916, 191 }, { 716, 412 },
					{ 796, 412 }, { 876, 412 } };
			...
			break;
		case 17:
			int[][] temp_point17 = { { 42, 356 }, { 651, 471 }, { 904, 219 },
					{ 40, 80 }, { 120, 80 }, { 200, 80 }, { 320, 10 } };
			...
			v_enemy.addElement(new Enemy(this, null, (Obstacle) v_obstacle
					.elementAt(0), 2, 2, 0));
			v_enemy.addElement(new Enemy(this, null, (Obstacle) v_obstacle
					.elementAt(1), -1, 2, Enemy.LEFT_PIER));
			count_enemy = v_enemy.size();
			break;
		case 18:
			int[][] temp_point18 = { { 46, 208 }, { 360, 193 }, { 440, 193 },
					{ 750, 193 }, { 830, 193 }, { 750, 71 }, { 830, 71 },
					{ 910, 71 }, { 940, 193 }, { 424, 330 }, { 440, 430 } };
			...
			break;
		case 19:
			int[][] temp_point19 = { { 45, 451 }, { 638, 453 }, { 762, 303 },
					{ 800, 170 }, { 424, 159 } };
			...
			break;
		case 20:
			int[][] temp_point20 = { { 45, 454 }, { 578, 161 }, { 797, 294 },
					{ 736, 426 }, { 865, 426 }, { 605, 458 }, { 314, 272 } };
			...
			break;
		case 21:
			int[][] temp_point21 = { { 45, 434 }, { 618, 485 }, { 698, 485 },
					{ 787, 294 }, { 805, 438 }, { 885, 438 } };
			...
			obstacle = new Obstacle(this, 5, 690, 457, Obstacle.WOOD_DOWN, 0,
					null);
			v_obstacle.addElement(obstacle);
			obstacle = new Obstacle(this, 4, 690, 457, 0, 0, null);
			v_obstacle.addElement(obstacle);
			obstacle = new Obstacle(this, 5, 890, 409, Obstacle.WOOD_DOWN, 0,
					null);
			v_obstacle.addElement(obstacle);
			obstacle = new Obstacle(this, 5, 880, 290, Obstacle.WOOD_DOWN, 0,
					obstacle);
			v_obstacle.addElement(obstacle);
			...
			break;
		case 22:
			int[][] temp_point22 = { { 40, 429 }, { 312, 445 }, { 808, 142 },
					{ 893, 236 }, { 812, 297 }, { 669, 478 }, { 875, 407 } };
			...
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(4),
					null, -1, 1, Enemy.LEFT_PIER));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(5),
					null, 0, 1, Enemy.LEFT_PIER));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(6),
					null, 0, 1, Enemy.LEFT_PIER));
			count_enemy = v_enemy.size();
			break;
		case 23:
			int[][] temp_point23 = { { 47, 402 }, { 610, 405 }, { 690, 405 },
					{ 770, 405 }, { 865, 373 }, { 527, 165 }, { 712, 223 },
					{ 527, 223 }, { 712, 165 } };
			...
			obstacle = new Obstacle(this, 5, 622, 191, Obstacle.WOOD_UP, 0,
					null);
			v_obstacle.addElement(obstacle);
			...
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(1),
					null, 0, 2, 0));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(3),
					null, 0, 2, Enemy.LEFT_PIER));
			v_enemy.addElement(new Enemy(this, (Pier) v_pier.elementAt(4),
					null, -1, 2, 0));
			count_enemy = v_enemy.size();
			break;
		case 24:
			int[][] temp_point24 = { { 45, 454 }, { 500, 250 }, { 880, 130 },
					{ 880, 290 }, { 880, 450 } };
			...
			break;
		case 25:
			int[][] temp_point25 = { { 45, 454 }, { 500, 450 }, { 780, 180 },
					{ 880, 320 }, { 880, 450 } };
	...
	public void show(Graphics g) {
		...
		if (y_move == 3)
			...
			y_move = 3;
		if (shooterIndex == 0) {
			g.drawImage(img_point_shooter, hero.x + x_map, hero.y - 120
					+ y_move, Graphics.BOTTOM | Graphics.HCENTER);
		} else {
			g.drawImage(img_point_shooter, shoottingEnemy.x + x_map,
					shoottingEnemy.y - 110 + y_move, Graphics.BOTTOM
							| Graphics.HCENTER);
		}
		...
		C.drawString(g, img_number, remain_missile + "", "0123456789", 560, 5,
				16, 23, 0, 0, 0);
		C.drawString(g, img_number, CanvasControl.mission + "", "0123456789",
				110, 5, 16, 23, 0, 0, 0);
		...
		if (hero.weak) {
			if (img_word_weak != null)
				g.drawImage(img_word_weak, 320, 100 + weak_w_y,
	...
	public void keyPressed(int keyCode) {
		...
		case C.KEY_3:
			...
			this.removeResource();
			CanvasControl.goodsIndex = keyCode - 48;
			try {
	...
	public void nextShooter() {
		if (shooterIndex != 0
				&& shooterIndex - 1 != v_enemy.indexOf(shoottingEnemy)
				&& !shootterDead) {
