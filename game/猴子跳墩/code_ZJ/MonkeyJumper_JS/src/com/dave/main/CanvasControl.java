...
import com.dave.tool.AudioPlay;
...
//	public static String iptvID="1571124907634";
	public static String iptvID="157510892999";
//	public static String iptvID="157112490763";
	...
	public JS_IPTV_PORP_TOOL js_iptv_prop_tool;
...
//	public static final String COMPANYURL_PHP 	= "http://222.46.20.151:9002/index.php";//正式PHP服务器
	...
	public final static String GAME_PROP_CODE = 					"P21002";
...
//		CanvasControl.iptvID=midlet.getAppProperty("userId");
...
//		if(isShowGF==0)return;
	...
	public void setState(byte state) {
		...
		case HOME_PAGE:{
			...
			if(game_page != null) {
				game_page.removeAllThisClassSources();
				game_page = null;
			}
			if(help_page != null) {
				help_page.removeAllThisClassSources();
	...
	public void loadJS_IPTV_PORP_TOOL(){
		js_iptv_prop_tool = new JS_IPTV_PORP_TOOL(mainMIDlet, this, GAME_PROP_CODE, "productIDa5000000000000000217432");
		js_iptv_prop_tool.setShowTime(500);
//		js_iptv_prop_tool.setTest();
		js_iptv_prop_tool.init();
