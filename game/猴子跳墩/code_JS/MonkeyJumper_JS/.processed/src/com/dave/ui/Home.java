...
public class Home {
	...
	private Image img_chosed_ranking;
	private Image img_unchose_start;
	private Image img_unchose_help;
	private Image img_unchose_ranking;
	...
	public void loadAllSources() {
		try {
			...
			img_chosed_ranking = Image.createImage("/home/rank_chosed.png");
			...
			img_unchose_ranking = Image.createImage("/home/rank_unchose.png");
...
//				canvasControl.setState(CanvasControl.ACTIVITY_PAGE);
	...
	public void showMe(Graphics canvas){
		...
		canvas.drawString(CanvasControl.VERSION + JS_IPTV_PORP_TOOL.js_PropVersion, 0, C.HEIGTH, Graphics.BOTTOM|Graphics.LEFT);
		...
		case 0 : {
			...
			canvas.drawImage(img_unchose_ranking, 230, 410, Graphics.TOP|Graphics.LEFT);
		} break;
		case 1 : {
		...
		case 2 : {
			canvas.drawImage(img_unchose_start, 220, 310, Graphics.TOP|Graphics.LEFT);
			canvas.drawImage(img_unchose_help, 220, 360, Graphics.TOP|Graphics.LEFT);
			canvas.drawImage(img_chosed_ranking, 230, 410, Graphics.TOP|Graphics.LEFT);
		} break;
		}
	}
}
