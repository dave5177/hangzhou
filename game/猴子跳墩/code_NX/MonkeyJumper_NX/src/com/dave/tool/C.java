...
public class C {
	...
	public static final short WIDTH = 640;  //屏幕宽度
	public static final short HEIGTH = 530;//屏幕高度
	public static final int C_TIME = 2000;//判断连续跳跃的间隔的毫秒数
	public static final short LIFE = 5;//初始生命值
	public static final byte A_TYPE_OUT = 0;
	public static final byte A_TYPE_EXIT = 1;
	public static final byte A_TYPE_BUY = 2;
	public static final byte A_TYPE_BUYSUCCESS = 3;
	public static final byte A_TYPE_RELIVE = 4;
