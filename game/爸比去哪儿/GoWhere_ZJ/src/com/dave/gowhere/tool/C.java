...
public class C {
	...
	public final static int RECT_LEFT = 1;//矩形左方
	public final static int RECT_UNDER = 2;//矩形下方
	public final static int RECT_RIGHT = 3;//矩形右方
	public final static int RECT_ABOVE = 4;//矩形上方
...
//	public final static String COMPANYURL_PHP = "http://61.191.44.224:8080/www.iptvgame.com/";// 安徽的服务器
	 ...
	 * @return 位置代码。
	 */
	public static int rectPosition(Rect rect1, Rect rect2) {
		if(rectInsect(rect1, rect2))
			return -1;
		if(rect1.y < rect2.y) {
			if(rect2.y - rect1.y < rect2.x - rect1.x)
				return RECT_LEFT;
			else if(rect2.y - rect1.y < rect1.x - rect2.x - rect2.w)
				return RECT_RIGHT;
			else 
				return RECT_ABOVE;
			...
			if(rect1.y - rect2.y - rect2.h < rect2.x - rect1.x)
				return RECT_LEFT;
			else if(rect1.y - rect2.y - rect2.h <  rect1.x - rect2.x - rect2.w)
				return RECT_RIGHT;
			else 
				return RECT_UNDER;
		}
